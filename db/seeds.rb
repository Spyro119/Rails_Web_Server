...
e = Employee.create!(lastname: 'Fortier', firstname: 'Nadya', function: 'Director', email: 'nadya.fortier@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Genest', firstname: 'Nicolas', function: 'Comm Rep', email: 'nicolas.genest@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Chantal', firstname: 'Martin', function: 'Director Assistant', email: 'martin.chantal@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Houde', firstname: 'Mathieu', function: 'Captain', email: 'mathieu.houde@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Gagnon', firstname: 'Remi', function: 'Engineer', email: 'remi.gagnon@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Lefrancois', firstname: 'Mathieu', function: 'Engineer', email: 'mathieu.lefrancois@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Savoie', firstname: 'Serge', function: 'Engineer', email: 'serge.savoie@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Boutin', firstname: 'David', function: 'Engineer', email: 'david.boutin@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Lortie', firstname: 'Mathieu', function: 'Engineer', email: 'mathieu.lortie@codeboxx.biz') if Rails.env.development?
e = Employee.create!(lastname: 'Carrier', firstname: 'Thomas', function: 'Engineer', email: 'thomas.carrier@codeboxx.biz') if Rails.env.development?   

# u = User.create!(username: 'Nicolasgenest', email: 'nicolas.genest@codeboxx.biz', company: 'Codeboxx1', password: 'password', password_confirmation: 'password') if Rails.env.development?

# u = User.create!(username: 'Nadyafortier', email: 'nadya.fortier@codeboxx.biz', company: 'Codeboxx2', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Martinchantal', email: 'martin.chantal@codeboxx.biz', company: 'Codeboxx3', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Mathieuhoude', email: 'mathieu.houde@codeboxx.biz', company: 'Codeboxx4', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Remigagnon', email: 'remi.gagnon@codeboxx.biz', company: 'Codeboxx5', password: 'password', password_confirmation: 'password' if Rails.env.development?
# u = User.create!(username: 'Mathieulefrancois', email: 'mathieu.lefrancois@codeboxx.biz', company: 'Codeboxx6', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Sergesavoie', email: 'serge.savoie@codeboxx.biz', company: 'Codeboxx7', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Davidboutin', email: 'david.boutin@codeboxx.biz', company: 'Codeboxx8', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Mathieulortie', email: 'mathieu.lortie@codeboxx.biz', company: 'Codeboxx9', password: 'password', password_confirmation: 'password') if Rails.env.development?
# u = User.create!(username: 'Thomascarrier', email: 'thomas.carrier@codeboxx.biz', company: 'Codeboxx10', password: 'password', password_confirmation: 'password') if Rails.env.development?
    end
end